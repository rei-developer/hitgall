      ...
      <b-form>
        <b-form-group label='이용약관'>
          <div class='termsBox'>제1조 [목적]
            본 약관은 '힛갤' 이 제공하는 서비스의 이용조건과 '힛갤' 운영에 관한 제반사항 규정을 목적으로 한다.

            제2조 [정의]
            ① 이 약관에서 사용하는 용어의 정의는 다음과 같다.
            1. '회원' 이라 함은 '힛갤' 의 약관에 동의하고 개인정보를 제공하여 회원가입을 한 자로서, '힛갤' 와의 이용계약을 체결하고 '힛갤' 에서 제공하는 서비스를 이용하는 자.
            2. '회원 아이디' (이하 'ID') 라 함은 '힛갤' 회원의 식별과 동 사이트 회원의 서비스 이용을 용이하게 하기 위하여 회원이 정하고 '힛갤' 이 승인하는 문자와 숫자의 조합.
            3. '비밀번호' 이라 함은 '힛갤' 회원이 정한 ID와 일치된 회원임을 확인하고 회원의 권익보호를 위하여 회원이 선정한 문자와 숫자 및 특수문자의 조합.
            4. '운영진' 이라 함은 '힛갤' 홈페이지를 개설하여 운영하는 운영진.
            5. '게시물' 이라 함은 '힛갤' 회원이 '힛갤' 을 이용함에 있어 '힛갤' 에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등.
            ...
            ② '힛갤' 의 공지사항 게시판에 별도의 운영 공지를 게시할 수 있다. '힛갤' 운영진은 필요한 경우 별도로 운영정책을 공지 안내할 수 있으며, 본 약관과 운영정책이 중첩될 경우 운영정책이 우선
            적용된다.
            ...
            ② 이용계약 체결은 '힛갤' 회원으로 등록하여 '힛갤' 의 서비스를 이용하려는 자가 '힛갤' 가입신청시 본 약관을 읽고 아래에 있는 '동의합니다' 를 선택하는 것으로 본 약관에 대한 동의의
            의사표시를 한 것이다.

            제5조 [회원가입]
            ① '힛갤' 회원으로 등록하여 본 사이트를 이용하려는 이용자는 사이트에서 요청하는 제반정보(이용자ID, 비밀번호, 닉네임 등)를 제공해야 한다.
            ② '힛갤' 와의 이용계약의 성립 시기는 '힛갤' 이 가입완료를 신청절차 상에 표시한 시점으로 한다.
            ③ '힛갤' 회원은 회원정보 기재 내용에 변경이 필요한 경우, 즉시 변경사항을 정정하여 기재해야 한다.
            ④ '힛갤' 은 제1항과 같이 '힛갤' 회원으로 가입할 것을 신청한 자가 다음 각 호에 해당할 경우, 회원가입을 거부하거나 자격을 상실하게 할 수 있다.
            ...
            ⑤ 타인의 정보를 도용하거나 허위의 정보를 등록하는 등 본인의 진정한 정보를 등록하지 않은 회원은 본 사이트 이용과 관련하여 아무런 권리를 주장할 수 없으며, 관계 법령에 따라 처벌 받을 수
            있다.
            ...
            ③ '힛갤' 운영진은 회원의 E-mail 및 고유 IP를 수집할 수 있으며 관계법령이 정하는 바에 따라 회원등록정보를 포함한 회원의 개인정보를 보호하기 위하여 노력한다. 단, 회원의 귀책사유로
            인해 노출된 정보에 대해 운영진은 일체의 책임을 지지 않는다.
            ④ '힛갤' 운영진은 회원이 미풍양속에 저해되거나 국가안보에 위배되는 게시물 등 위법한 게시물을 등록 · 배포할 경우 관련기관의 요청이 있을 경우 관련기관에 '힛갤' 회원의 고유IP를 수집하거나
            정보를 열람하게 할 수 있으며 해당 자료를 관련기관에 제출할 수 있다.

            제7조 [서비스의 제공 및 변경]
            ① '힛갤' 은 '힛갤' 회원에게 아래와 같은 서비스를 제공한다.
            1. 커뮤니티 서비스 (게시판)
            2. 검색 서비스
            3. 기타 '힛갤' 이 자체 개발하거나 다른 회사와의 협력계약 등을 통해 '힛갤' 회원들에게 제공하는 일체의 서비스
            ② '힛갤' 은 본 사이트 서비스의 내용 및 제공일자를 회원에게 통지하고, 제1항에 정한 서비스를 변경하여 제공할 수 있다.

            제8조 [이용시간]
            ① '힛갤' 서비스 이용시간은 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 단, '힛갤' 시스템 정기점검, 증설 및 교체를 위해 본 사이트 및 운영진이
            정한 날이나 시간에 서비스를 일시중단 할 수 있으며 예정된 작업으로 인한 서비스 일시 중단은 사이트의 홈페이지에 사전에 공지한다.
            ② 제1항에 의한 서비스 중단의 경우에 '힛갤' 은 회원에게 사전 공지해야 한다. 단, '힛갤' 을 통제할 수 없는 사유로 인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크 장애,
            시스템다운 등)으로 인하여 사전 통지가 불가능한 경우에는 사후 공지로 대체할 수 있다.

            제9조 [운영진의 의무]
            ① '힛갤' 은 본 사이트 서비스이용과 관련하여 발생하는 회원의 불만 또는 피해구제요청을 적절하게 처리할 수 있도록 필요한 인력 및 시스템을 구비한다.
            ② '힛갤' 은 본 사이트 서비스이용과 관련하여 회원으로부터 제기된 의견이나 불만이 정당하다고 인정할 경우에는 이를 처리해야 한다. '힛갤' 회원이 제기한 의견이나 불만사항에 대해서는 게시판을
            활용하여 회원에게 처리과정 및 결과를 전달한다.
            ③ '힛갤' 운영진이 특정 회원 및 불특정다수 회원에 통지할 사항이 있는 경우 회원정보에 등록된 메일주소를 사용한다.

            제10조 [회원의 의무]
            ① '힛갤' 회원은 본 약관에서 규정하는 사항과 운영진이 정한 제반규정, 공지사항 및 운영정책 등 사이트가 공지하는 사항 및 관계법령을 준수하여야 하며, 기타 '힛갤' 의 업무에 방해가 되는
            행위나 '힛갤' 및 운영진 명예를 손상시키는 행위를 금지한다.
            ...
            ⑤ '힛갤' 회원은 주기적으로 '힛갤' 의 공지사항을 확인하여야 한다. 공지사항 미확인으로 인한 피해 혹은 공지사항 미준수로 인한 책임은 회원 당사자에게 귀속되며, '힛갤' 은 이에 대해
            책임지지 않는다.
            ⑥ '힛갤' 회원은 그 귀책사유로 인하여 '힛갤' 나 다른 회원이 입은 손해를 배상할 책임이 있다.

            제11조 [이용제한 및 징계]
            ① '힛갤' 의 공지사항에 위반하는 행위를 한 회원이 있을 경우 '힛갤' 은 회원의 회원자격을 적절한 방법으로 제한 및 정지, 상실시킬 수 있다.
            ② '힛갤' 은 회원의 의무위반행위에 따른 다른 회원들의 선의의 피해를 방지하고 '힛갤' 운영상 필요하다고 판단하는 경우 징계대상자의 의무위반 내역과 아이디, 닉네임, IP를 전체 공개할 수
            있다.
            ③ '힛갤' 은 회원의 행위로 인한 피해가 발생하였을 경우 그 행위자에게 민․형사상 책임을 물을 수 있다.

            제12조 [탈퇴]
            ① '힛갤' 회원은 '힛갤' 에 언제든지 자신의 회원 등록 말소(이하 '회원 탈퇴')를 요청할 수 있으며 '힛갤' 은 위 요청을 받은 즉시 해당 회원의 회원 탈퇴를 위한 절차를 시행한다.
            ...
            ③ 회원의 회원 탈퇴신청과 동시에 '힛갤' 이 제공하는 본 사이트 관련 프로그램이 회원관리 화면에서 자동적으로 영구 삭제된다. 그리하여 '힛갤' 은 더 이상 회원탈퇴 신청자의 정보를 볼 수
            없다.

            제13조 [게시물 관리]
            ① '힛갤' 의 게시물과 자료의 관리 및 운영의 책임은 '힛갤' 운영진에게 있습니다. 운영진은 항상 불량 게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나
            신고를 받으면 해당 게시물 및 자료를 삭제하고 이를 게시 및 등록한 자에게 주의를 주어야 한다. 단, 이용회원이 올린 게시물에 대해서는 게시자 본인에게 책임이 있으니 회원 스스로 본 이용약관에서
            위배되는 게시물은 게재해서는 안된다.
            ...
            ④ '힛갤' 및 운영진은 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시중단(전송중단)할 수 있으며, 게시중단 요청자와
            게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련기관의 결정 등이 이루어져 본 사이트에 접수된 경우 이에 따른다.

            제14조 [게시물의 보관]
            운영진 불가피한 사정으로 본 '힛갤' 을 중단하게 될 경우, '힛갤' 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 취하기 위해 노력해야 한다.

            제15조 [게시물 저작권 관련]
            ① '힛갤' 회원은 동의 없이 게시물을 상업적으로 이용할 수 없다. 단, 비영리 목적인 경우는 그러하지 아니하며, 또한 서비스 내의 게재권을 갖는다.
            ② '힛갤' 회원은 '힛갤' 을 이용하여 취득한 정보를 임의 가공, 판매하는 행위 등 '힛갤' 에 게재된 자료를 상업적으로 사용할 수 없다.
            ③ '힛갤' 은 회원이 게시하거나 등록하는 '힛갤' 내의 내용물 및 게시 내용에 대해 제13조 각 호에 해당된다고 판단되는 경우 사전통지 없이 삭제하거나 이동 또는 등록 거부할 수 있다.

            제16조 [재정]
            ① '힛갤' 은 재정 건전성을 확보하기 위하여 기부금 모금, 광고 게재 등의 각종 재정적 조치를 취할 수 있다.
            ...
            제18조 면책
            ① '힛갤' 은 회원이 본 커뮤니티의 서비스 제공으로부터 기대되는 이익을 얻지 못하였거나 서비스 자료에 대한 취사선택 또는 이용으로 발생하는 손해 등에 대해서는 책임이 면제된다.
            ② '힛갤' 은 본 커뮤니티의 서비스 기반 및 타 통신업자가 제공하는 전기통신서비스의 장애로 인한 경우에는 책임이 면제되며 본 사이트의 서비스 기반과 관련되어 발생한 손해에 대해서는 사이트의
            이용약관에 준한다.
            ...
            ⑨ 운영진은 서버 등 설비의 관리, 점검, 보수, 교체 과정 또는 소프트웨어의 운용 과정에서 고의 또는 고의에 준하는 중대한 과실 없이 발생할 수 있는 시스템의 장애, 제3자의 공격으로 인한
            시스템의 장애, 국내외의 저명한 연구기관이나 보안관련 업체에 의해 대응방법이 개발되지 아니한 컴퓨터 바이러스 등의 유포나 기타 운영자가 통제할 수 없는 불가항력적 사유로 인한 회원의 손해에
            대하여 책임지지 않는다.
          </div>
        </b-form-group>
        <b-form-group label='개인정보취급방침'>
          <div class='termsBox'>1. 개인정보 수집목적 및 이용목적: 회원제 서비스 이용에 따른 본인 확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인,
            고지사항 전달
