...
② 제1항에 의한 서비스 중단의 경우에 '힛갤' 은 회원에게 사전 공지해야 한다. 단, '힛갤' 을 통제할 수 없는 사유로 인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크 장애, 시스템다운 등)으로 인하여 사전 통지가 불가능한 경우에는 사후 공지로 대체할 수 있다.

제9조 [운영진의 의무]
① '힛갤' 은 본 사이트 서비스이용과 관련하여 발생하는 회원의 불만 또는 피해구제요청을 적절하게 처리할 수 있도록 필요한 인력 및 시스템을 구비한다.
② '힛갤' 은 본 사이트 서비스이용과 관련하여 회원으로부터 제기된 의견이나 불만이 정당하다고 인정할 경우에는 이를 처리해야 한다. '힛갤' 회원이 제기한 의견이나 불만사항에 대해서는 게시판을 활용하여 회원에게 처리과정 및 결과를 전달한다.
...
⑤ '힛갤' 회원은 주기적으로 '힛갤' 의 공지사항을 확인하여야 한다. 공지사항 미확인으로 인한 피해 혹은 공지사항 미준수로 인한 책임은 회원 당사자에게 귀속되며, '힛갤' 은 이에 대해 책임지지 않는다.
...
② '힛갤' 은 회원의 의무위반행위에 따른 다른 회원들의 선의의 피해를 방지하고 '힛갤' 운영상 필요하다고 판단하는 경우 징계대상자의 의무위반 내역과 아이디, 닉네임, IP를 전체 공개할 수 있다.
...
③ 회원의 회원 탈퇴신청과 동시에 '힛갤' 이 제공하는 본 사이트 관련 프로그램이 회원관리 화면에서 자동적으로 영구 삭제된다. 그리하여 '힛갤' 은 더 이상 회원탈퇴 신청자의 정보를 볼 수 없다.
...
② '힛갤' 은 본 커뮤니티의 서비스 기반 및 타 통신업자가 제공하는 전기통신서비스의 장애로 인한 경우에는 책임이 면제되며 본 사이트의 서비스 기반과 관련되어 발생한 손해에 대해서는 사이트의 이용약관에 준한다.
